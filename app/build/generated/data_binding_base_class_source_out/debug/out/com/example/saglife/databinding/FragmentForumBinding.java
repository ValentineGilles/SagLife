...
public final class FragmentForumBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textForum;

  private FragmentForumBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textForum) {
    this.rootView = rootView;
    this.textForum = textForum;
  }
  ...
  public static FragmentForumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.text_forum;
      TextView textForum = ViewBindings.findChildViewById(rootView, id);
      if (textForum == null) {
        break missingId;
      }

      return new FragmentForumBinding((ConstraintLayout) rootView, textForum);
    }
